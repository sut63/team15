...
func (eq *EquipmentQuery) QueryRoomdetail() *RoomdetailQuery {
...
func (eq *EquipmentQuery) WithRoomdetail(opts ...func(*RoomdetailQuery)) *EquipmentQuery {
	query := &RoomdetailQuery{config: eq.config}
	for _, opt := range opts {
		opt(query)
	}
	eq.withRoomdetail = query
	return eq
}
