...
func Roomprice(v int) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func Roomtypename(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoompriceEQ(v int) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRoomprice), v))
	})
}
...
func RoompriceNEQ(v int) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoompriceIn(vs ...int) predicate.Room {
...
func RoompriceNotIn(vs ...int) predicate.Room {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func RoompriceGT(v int) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoompriceGTE(v int) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoompriceLT(v int) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoompriceLTE(v int) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameEQ(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRoomtypename), v))
	})
}
...
func RoomtypenameNEQ(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameIn(vs ...string) predicate.Room {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func RoomtypenameNotIn(vs ...string) predicate.Room {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func RoomtypenameGT(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameGTE(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameLT(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameLTE(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameContains(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameHasPrefix(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameHasSuffix(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameEqualFold(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func RoomtypenameContainsFold(v string) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
...
func HasQuantity() predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(QuantityTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, QuantityTable, QuantityColumn),
		)
...
func HasQuantityWith(preds ...predicate.Quantity) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasStaytype() predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(StaytypeTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, StaytypeTable, StaytypeColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasStaytypeWith(preds ...predicate.StayType) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasFacilities() predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FacilitiesTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, FacilitiesTable, FacilitiesPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasFacilitiesWith(preds ...predicate.Facility) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEquipments() predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(EquipmentsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, EquipmentsTable, EquipmentsPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasEquipmentsWith(preds ...predicate.Equipment) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasNearbyplace applies the HasEdge predicate on the "nearbyplace" edge.
func HasNearbyplace() predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(NearbyplaceTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, NearbyplaceTable, NearbyplacePrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasNearbyplaceWith applies the HasEdge predicate on the "nearbyplace" edge with a given conditions (other predicates).
func HasNearbyplaceWith(preds ...predicate.NearbyPlace) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(NearbyplaceInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, NearbyplaceTable, NearbyplacePrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasCleaningrooms() predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCleaningroomsWith(preds ...predicate.CleaningRoom) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
